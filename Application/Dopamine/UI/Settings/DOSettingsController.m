...
- (id)specifiers
{
    if(_specifiers == nil) {
        ...
        if (envManager.isJailbroken) {
            ...
            PSSpecifier *hiddenRootSpecifier = [PSSpecifier preferenceSpecifierNamed:@"" target:self set:defSetter get:defGetter detail:nil cell:PSStaticTextCell edit:nil];
            [hiddenRootSpecifier setProperty:@"Button_Hidden_Root" forKey:@"title"];
            [hiddenRootSpecifier setProperty:[DOButtonCell class] forKey:@"cellClass"];
            [hiddenRootSpecifier setProperty:buttonHeight forKey:@"height"];
            [hiddenRootSpecifier setProperty:@"eye.slash" forKey:@"image"];
            [hiddenRootSpecifier setProperty:@"hiddenRootPressed" forKey:@"action"];
            [specifiers addObject:hiddenRootSpecifier];
        }
...
- (void)hiddenRootPressed
{
    [self.navigationController pushViewController:[[DOHiddenRootListController alloc] init] animated:YES];
}
